...
from utils.data.codebase.load_data.base import LoadDataset


class TourismDataset(LoadDataset):
    DATASET_PATH = "utils/data/assets/datasets/tourism/"
    DATASET_NAME = "T"
    ...
    context_length = {"Yearly": 1, "Quarterly": 8, "Monthly": 60}
